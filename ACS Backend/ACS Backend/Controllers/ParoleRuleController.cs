...
public class ParoleRuleController : ControllerBase
{
    private ParoleRuleService _paroleRuleService;

    public ParoleRuleController(ParoleRuleService paroleRuleService)
    {
    ...
    [HttpPost("Add")]
    public async Task<IActionResult> Create([FromBody] NewNoteModel paroleRule)
    {
        try
        {
